...
class mergePictures
{
	...
	*/
	function merge($pos)
	{
		...
		{
			case 'left':
				$this->image = imagecreatetruecolor(($this->foto1->tam + $this->foto2->tam),$this->foto2->alt);
				imagecopy($this->image, $this->foto1->img , 0 , 0 , 0, 0, $this->foto1->tam, $this->foto1->alt);
				imagecopyresampled($this->image,$this->foto2->img,$this->foto1->tam,0,0,0,$this->foto2->tam ,$this->foto2->alt,$this->foto2->tam,$this->foto2->alt);
			break;
			case 'right':
				$this->image = imagecreatetruecolor(($this->foto1->tam + $this->foto2->tam),$this->foto2->alt);
				imagecopy($this->image, $this->foto2->img , 0 , 0 , 0, 0, $this->foto2->tam, $this->foto2->alt);
				imagecopyresampled($this->image,$this->foto1->img,$this->foto2->tam,0,0,0,$this->foto1->tam ,$this->foto1->alt,$this->foto1->tam,$this->foto1->alt);
			break;
			case "up":
